...
plot(x = hpcs$DateTime, y = hpcs$Voltage,type="l", xlab="datetime", ylab="Voltage")
...
plot(x = hpcs$DateTime, y = hpcs$Global_reactive_power, type = "l", xlab = "datetime", ylab="Global_reactive_power")
dev.off()
